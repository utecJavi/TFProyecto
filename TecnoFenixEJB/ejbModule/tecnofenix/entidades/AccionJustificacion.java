...
public class AccionJustificacion implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="accion_justificacion_seq")
    @SequenceGenerator(name="accion_justificacion_seq", sequenceName="accion_justificacion_seq", allocationSize=1)

...
//				}
				if(dateinicio1.getDate()!=null) {
					...
					calendar.set(Calendar.HOUR_OF_DAY, 0); // Establecemos la hora a las 9 de la ma�ana
				...
				if(datefin1.getDate()!=null) {
					...
					calendar.set(Calendar.HOUR_OF_DAY, 23); // Establecemos la hora a las 9 de la ma�ana

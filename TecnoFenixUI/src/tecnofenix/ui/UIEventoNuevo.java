...
//				System.out.println("Presiono el boton aceptar tutores tama�o lista "+uiListaTutores.getListTutoresSeleccionados().size());
	...
	public Boolean validarDatos() {
		...
		if(fechaFinDateChooser.getDate() == null) {
		    ...
		    if (fechaFin.before(fechaInicio)) {
		        JOptionPane.showMessageDialog(null, "La fecha de finalizaci�n no puede ser anterior a la fecha de inicio", "Error", JOptionPane.ERROR_MESSAGE);
		        return false;
		    }
		}
